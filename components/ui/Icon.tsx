...
export function PhosphorStar({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M128 8 156.2 89.2 242.1 90.9 173.7 142.8 198.5 225.1 128 176 57.5 225.1 82.3 142.8 13.9 90.9 99.8 89.2Z" />
    </svg>
  );
}
